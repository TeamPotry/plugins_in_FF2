...
public void OnClientDisconnect(int client)
{
    ...
    {
        char steamAccount[32], steamProfileUrl[150], playerName[64], steamAccount2[32], accountText[80];
...
void ReportToDiscord(int client, int target, char[] reason)
{
    ...
    char steamAccount[32], targetSteamAccount[32], steamUrl[200], targetSteamUrl[200], playerName[64];
    char temp[100], mapName[80], timeString[60];
    float targetPos[3];
...
{
    char[] url = "http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?"; // Request url
    Handle HTTPRequest = SteamWorks_CreateHTTPRequest(k_EHTTPMethodGET, url); // Handle
    bool setnetwork = SteamWorks_SetHTTPRequestNetworkActivityTimeout(HTTPRequest, 10); // Set timeout to 10 seconds
    bool setkey = SteamWorks_SetHTTPRequestGetOrPostParameter(HTTPRequest, "key", STEAM_API_KEY); // Set required parameters
